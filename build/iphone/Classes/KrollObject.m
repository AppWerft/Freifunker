...
//@interface FreifunkerObject : NSObject
//@end

@interface FreifunkerObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[FreifunkerObject class]])
		{
			for (NSString *key in [[(FreifunkerObject*)o modules] allKeys])
			{
