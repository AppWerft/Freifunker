...
/**
 Base class for all Freifunker views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Freifunker view hierarchy (such as wrapped iOS UIViews) was touched.
