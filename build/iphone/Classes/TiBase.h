...
// in simulator we redefine to format for Freifunker Developer console
...
{\
	NSString * exceptionName = [@"org.freifunker." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.freifunker";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIFreifunkerNativeItemNone = -1, 
	UIFreifunkerNativeItemSpinner = -2,
	UIFreifunkerNativeItemProgressBar = -3,
	
	UIFreifunkerNativeItemSlider = -4,
	UIFreifunkerNativeItemSwitch = -5,
	UIFreifunkerNativeItemMultiButton = -6,
	UIFreifunkerNativeItemSegmented = -7,
	
	UIFreifunkerNativeItemTextView = -8,
	UIFreifunkerNativeItemTextField = -9,
	UIFreifunkerNativeItemSearchBar = -10,
	
	UIFreifunkerNativeItemPicker = -11,
	UIFreifunkerNativeItemDatePicker = -12,
	
	UIFreifunkerNativeItemInfoLight = -13,
	UIFreifunkerNativeItemInfoDark = -14,
	
	UIFreifunkerNativeItemDisclosure = -15,
	
	UIFreifunkerNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Freifunker instances of
