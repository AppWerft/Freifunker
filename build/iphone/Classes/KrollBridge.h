...
@interface FreifunkerObject : KrollCoverageObject {
#else
@interface FreifunkerObject : KrollObject {
#endif
@private
...
extern NSString * Freifunker$ModuleRequireFormat;
