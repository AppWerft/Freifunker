module.exports = [{
	...
	"name" : "Halle (Saale)",
	"url" : "http://freifunk-halle.org/Tools/JSON.ashx"
}, {
	"name" : "Hamburg",
	...
	"name" : "München",
	"url" : "http://map.freifunk-muenchen.de/nodes.json"
}, {
	"name" : "Münster",
	...
	"name" : "Rhein Neckar",
	"url" : "http://map.freifunk-rhein-neckar.de/nodes.json"
}, {
	"name" : "Rheinland",
	"url" : "http://ffmap.freifunk-rheinland.net/nodes.json"
}, {
	name : "Rothenburg (Tauber)",
	...
	name : 'Ulm',
	url : 'http://vpn6.freifunk-ulm.de/nodes.json'
}, {
	"name" : "Westpfalz",
